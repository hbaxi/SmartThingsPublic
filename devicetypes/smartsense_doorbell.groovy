 ...
 */
metadata {
	definition (name: "SmartSense Doorbell", namespace: "hbaxi", author: "SmartThings") {
	...
	tiles(scale: 2) {
		multiAttributeTile(name:"acceleration", type: "generic", width: 6, height: 4){
			tileAttribute ("device.acceleration", key: "PRIMARY_CONTROL") {
				attributeState "active", label:'Ding Dong', icon:"st.Home.home30", backgroundColor:"#B0E0E6"
				attributeState "inactive", label:'Doorbell', icon:"st.Home.home30", backgroundColor:"#53a7c0"
			}
		}

		standardTile("contact", "device.contact", width: 2, height: 2) {
			state("open", label:'.....', icon:"st.Home.home30", backgroundColor:"#53a7c0")
